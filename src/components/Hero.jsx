    ...
    <section className="flex w-full px-[50px] h-fit justify-center items-center gap-[138px]">
      ...
      <div className="flex flex-col items-start gap-12">
        ...
        <div className="flex items-start gap-2">
          ...
          >
            <img src={stars} alt="stars" className="absolute left-1/2 top-1/2 w-[600%] h-[600%] -translate-x-1/2 -translate-y-1/2 object-cover opacity-60 animate-[spin_7s_linear_infinite] group-hover:[animation-play-state:paused] pointer-events-none" />
      ...
      <div
        className="inline-flex p-4 flex-col items-center gap-2 border border-white shadow-[0_0_40px_0_rgba(0,0,0,0.03)] transition-transform duration-500 ease-[cubic-bezier(0.4,0.0,0.2,1)] hover:rotate-[2deg] hover:translate-x-3 hover:scale-105 cursor-pointer"
        style={{
